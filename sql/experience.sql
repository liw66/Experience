...
CREATE TABLE `sys_dept` (
  ...
  `state` tinyint(1) unsigned DEFAULT NULL COMMENT '状态 0 禁用 1 启用',
...
CREATE TABLE `sys_user` (
  ...
  `sex` tinyint(1) unsigned DEFAULT NULL COMMENT '性别 0 未知的性别 1 男性 2 女性 9 未说明的性别',
