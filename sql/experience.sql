...
CREATE TABLE `sys_log` (
  ...
  `createdat` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`logid`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COMMENT='系统日志表';
...
INSERT INTO `sys_log` VALUES ('94', '7', 'admin', '登录', 'com.li.experience.modules.sys.controller.LoginController.login', '{\"password\":\"admin\",\"username\":\"admin\"}', 'Result{code=0, msg=\'ok\', data=null}', 'POST', '0', '10.10.0.14', '15', '0', '2019-10-17 08:52:25');
